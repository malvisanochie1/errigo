        ...
        <div className="max-w-3xl w-full space-y-8 bg-white p-10 rounded-2xl shadow-lg">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Our Refund Policy outlines the terms under which you may request a
          ...
          <div className="text-gray-700 space-y-6">
            <section>
              ...
              <p>
                ...
                within <span className="font-medium">7 days</span> of purchase.
                Refunds may only apply if the service or product delivered does
                not meet the agreed description or has technical issues that
                prevent use.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                <span className="font-medium">support@example.com</span> with
                proof of purchase and details of your request. Approved refunds
                will be processed back to your original payment method within{" "}
            ...
            <section>
              ...
              <p>
                ...
                please check with your bank or payment provider. If the issue
                persists, contact us directly for assistance.
              </p>
            </section>
